    ...
    <div className="p-6 md:p-12 pb-32 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[200px]">
        {visibleProjects.map((project, i) => {
          // Asymmetrical Pattern: 2-1, 1-1-1, 1-2
          ...
          return (
            ...
            >
              <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
                <div className="flex justify-between items-start">
                  <div className="flex gap-2 flex-wrap">
                    {project.tags.slice(0, 2).map(tag => (
                      <span key={tag} className="px-2 py-1 text-[10px] font-medium tracking-wide uppercase rounded-full bg-stone-100 dark:bg-zinc-800 text-stone-500 dark:text-stone-400 border border-stone-200 dark:border-zinc-700">
                        {tag}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  <h3 className={clsx(
                    "font-bold text-stone-900 dark:text-white mb-1 leading-tight",
              ...
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-gradient-to-br from-stone-100 to-stone-200 dark:from-zinc-800 dark:to-zinc-900 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </motion.div>
          );
        })}
      </div>
