...
The result is a focused reference for ai workflow starter, including the problem, the technical direction, and the lessons that carry forward to future builds.
