    ...
    <main className="min-h-screen bg-ink text-ink-text">
      <header className="site-shell flex items-center justify-between py-6">
        <Link to="/" className="flex items-center gap-3 font-semibold tracking-tight">
          ...
          <span>Tentacio<span className="text-ink-muted">/lab</span></span>
        </Link>
      ...
      <section className="site-shell grid min-h-[70vh] items-center gap-12 pb-20 pt-16 lg:grid-cols-[1.2fr_0.8fr] lg:pt-24">
        <div>
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-ink-muted">{profile.detail}</p>
        ...
        <div className="relative">
          ...
          <div className="panel relative overflow-hidden p-6 sm:p-8">
            <div className="mb-16 flex items-center justify-between text-xs text-ink-muted"><span className="eyebrow">Signal / 2026</span><Sparkles size={16} className="text-accent" /></div>
            <div className="space-y-5">
              <div className="flex items-center justify-between border-b border-ink-line pb-4"><span className="text-sm text-ink-muted">Projects shipped</span><span className="text-3xl font-semibold">{projects.length}</span></div>
              <div className="flex items-center justify-between border-b border-ink-line pb-4"><span className="text-sm text-ink-muted">Current focus</span><span className="text-right text-sm font-medium">Agentic systems</span></div>
              <div className="flex items-center justify-between"><span className="text-sm text-ink-muted">Default mode</span><span className="flex items-center gap-2 text-sm font-medium"><span className="h-2 w-2 rounded-full bg-accent" /> Local-first</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="site-shell grid gap-6 border-y border-ink-line py-7 text-sm sm:grid-cols-3">
        <div><p className="eyebrow mb-2">01 / Approach</p><p className="text-ink-muted">Find the constraint. Make it observable.</p></div>
        <div><p className="eyebrow mb-2">02 / Craft</p><p className="text-ink-muted">Ship the smallest useful system.</p></div>
        <div><p className="eyebrow mb-2">03 / Record</p><p className="text-ink-muted">Track decisions so momentum compounds.</p></div>
      </section>
      ...
      <section id="archive" className="site-shell scroll-mt-8 py-24">
        <div className="mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          ...
          <p className="max-w-sm text-sm leading-6 text-ink-muted">A living index of AI, full-stack, infrastructure, and systems work. Open a card for the context and the local write-up.</p>
        </div>
        <BentoGrid />
      </section>

      <footer className="site-shell flex flex-col gap-6 border-t border-ink-line py-8 text-sm text-ink-muted sm:flex-row sm:items-center sm:justify-between">
